# Generated by Powerlevel10k configuration wizard on 2020-12-15 at 13:25 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PYENV_CONTENT_EXPANSION='${P9K_CONTENT}${${P9K_PYENV_PYTHON_VERSION:#$P9K_CONTENT}:+ $P9K_PYENV_PYTHON_V
ERSION}'
